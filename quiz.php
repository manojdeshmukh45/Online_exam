...
<body onload="countdown()";onload="window.location.reload()";>
<?php
include("header.php");
?>
Time: Min<input id="minutes" type="text"  style="width: 22px;"> Sec<input id="seconds" type="text" style="width: 22px">
<?php
...
echo "<tr><td class=style8><input type=radio id=r name=ans value=1>$row[3]";
echo "<tr><td class=style8> <input type=radio name=ans id=r1 value=2>$row[4]";
echo "<tr><td class=style8><input type=radio name=ans  id=r2 value=3>$row[5]";
echo "<tr><td class=style8><input type=radio name=ans id=r3 value=4>$row[6]";
